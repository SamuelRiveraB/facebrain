  ...
  return createPortal(
    <div className="absolute top-0 left-0 flex justify-center items-center z-40 bg-[rgba(0,0,0,0.5)] w-[100vw] h-[100vh]">
      <div
        ref={formRef}
        id="profile"
        className="w-full rounded-lg max-w-[500px] shadow-2xl bg-white mx-6 text-black"
      >
        <div className="relative p-4 md:p-12 text-center lg:text-left">
          <ProfileImage w={20} h={20} />
          <div
            className="absolute cursor-pointer text-3xl top-0 right-2"
